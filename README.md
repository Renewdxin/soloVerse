...
> 想先看效果？网页版 `npm run demo:web`（下图），或终端版 `npm run demo`——都零配置、全程跑真实 core 代码。见 [demo/README.md](./demo/README.md)。

![管家 · 收发站：左边在群里收发，右边实时台账 + 快进时间，自动捕获承诺、到点才出声、逾期私聊本人](./docs/assets/web-sandbox.png)
